...
namespace DS4WinWPF.DS4Control.DTOXml
{
    ...
    public class ProfileDTO : IDTO<BackingStore>
    {
        ...
        //ss7 start
        //
        private int _lightgunAnalog;
        [XmlElement("LightgunAnalog")]
        public int LightgunAnalog {
            get => _lightgunAnalog;
            set => _lightgunAnalog = value;
        }

        private int _lightgunRecenter;
        [XmlElement("LightgunRecenter")]
        public int LightgunRecenter {
            get => _lightgunRecenter;
            set => _lightgunRecenter = value;
        }
        
        private int _lightgunReload;
        [XmlElement("LightgunReload")]
        public int LightgunReload {
            get => _lightgunReload;
            set => _lightgunReload = value;
        }
        private int _lightgunFire;
        [XmlElement("LightgunFire")]
        public int LightgunFire {
            get => _lightgunFire;
            set => _lightgunFire = value;
        }
        //
        // ss7 end
        ...
        public void MapFrom(BackingStore source)
        {
            ...
            // ss7 start
            //
            LightgunAnalog = source.lightgunAnalog[deviceIndex];
            LightgunRecenter = source.lightgunRecenter[deviceIndex];
            LightgunReload = source.lightgunReload[deviceIndex];
            LightgunFire = source.lightgunFire[deviceIndex];
            //
            // ss7 end
        ...
        public void MapTo(BackingStore destination)
        {
            ...
            // ss7 start
            //
            destination.lightgunAnalog[deviceIndex] = LightgunAnalog;
            destination.lightgunRecenter[deviceIndex] = LightgunRecenter;
            destination.lightgunReload[deviceIndex] = LightgunReload;
            destination.lightgunFire[deviceIndex] = LightgunFire;
            //
            // ss7 end
