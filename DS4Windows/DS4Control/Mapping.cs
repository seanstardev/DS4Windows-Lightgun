...
namespace DS4Windows
{
    public class Mapping
    {
        ...
        public static DS4State SetCurveAndDeadzone(int device, DS4State cState, DS4State dState)
        {
            ...
            // ss7
            byte defaultLX = dState.LX;
            byte defaultLY = dState.LY;
            byte defaultRX = dState.RX;
            byte defaultRY = dState.RY;
            ...
            */
            ...
            // ss7 start
            //
            if (Global.GyroOutputMode[device] == GyroOutMode.Lightgun) {
                if (Global.lightgunAnalog[device] == 0) // left
                {
                    dState.LX = defaultLX;
                    dState.LY = defaultLY;
                }
