        ...
        private unsafe void ReadInput()
        {
            unchecked
            {
                ...
                while (!exitInputThread)
                {
                    ...
                    if (allowLX) cState.LX = inputReport[1 + reportOffset];
                    if (allowLY) cState.LY = inputReport[2 + reportOffset];
                    if (allowRX) cState.RX = inputReport[3 + reportOffset];
                    if (allowRY) cState.RY = inputReport[4 + reportOffset];
